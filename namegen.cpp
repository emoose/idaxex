...
const char* xamNameGen(int id)
{
  ...
  if (id == 0x000000DB) return "NetDll_XHttpCrackUrl";
  ...
  if (id == 0x00000311) return "Refresh";
  if (id == 0x00000312) return "Refresh";
  ...
  if (id == 0x0000031C) return "XamBuildSharedSystemResourceLocator";
  ...
  if (id == 0x000005E6) return "EnumerateMediaObjects";
  ...
  if (id == 0x000005EC) return "EnumerateMediaObjects";
  if (id == 0x000005ED) return "EnumerateMediaObjects";
  ...
  if (id == 0x000005F0) return "EnumerateMediaObjects";
  ...
  if (id == 0x00000826) return "Refresh";
...
const char* xboxkrnlNameGen(int id)
{
  ...
  if (id == 0x000001DF) return "KiApcNormalRoutineNop";
